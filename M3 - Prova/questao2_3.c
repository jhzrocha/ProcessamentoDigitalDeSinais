...
int main() {
    ...
    const float u = 0.05; // Passo de adaptação
    ...
    printf("Processamento concluído. Sinal de erro salvo em erro_Q2_C.pcm\n");
    return 0;
}
